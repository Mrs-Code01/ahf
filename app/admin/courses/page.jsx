...
import { Plus, LogOut, ShoppingBag, BookOpen, Users, CheckCircle, Clock } from 'lucide-react';
                  ...
                  >
                    <div className="grid md:grid-cols-4 gap-4">
                      <div>
                        ...
                        <p className="font-bold text-gray-800">{enrollment.user_name}</p>
                        <p className="text-sm text-gray-600">{enrollment.user_email}</p>
                      </div>

                      <div>
                        <p className="text-xs text-gray-500 font-medium mb-1">COURSE</p>
                        <p className="font-semibold text-gray-800">{enrollment.course_name}</p>
                      ...
                      <div>
                        ...
                        <p className="font-bold text-gray-800">₦{enrollment.amount_paid}</p>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        >
                          {enrollment.payment_status === 'completed' ? '✅ Completed' :
                           enrollment.payment_status === 'pending' ? '⏳ Pending' : '❌ Failed'}
                        </span>
