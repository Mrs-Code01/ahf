...
//       console.log("2. URL:", process.env.NEXT_PUBLIC_SUPABASE_URL);
//       const { data, error } = await supabase
//         .from("volunteer_applications")
//         .select("*")
//         .order("created_at", { ascending: false });
//       console.log("3. data:", data);
//       console.log("4. error:", JSON.stringify(error));
//       console.log("5. error keys:", error ? Object.keys(error) : "no error");
//       if (error) throw error;
//       setAllApplications(data || []);
//     } catch (err) {
//       console.log("6. caught:", JSON.stringify(err));
//       console.log("7. err.message:", err.message);
//       console.log("8. err.code:", err.code);
//       setAllApplications([]);
//     } finally {
//       setLoading(false);
//     }
...
//     if (!window.confirm("✅ Approve this volunteer application?")) return;
...
//                   </div>
//                   <span
//                     className={`px-4 py-2 rounded-full font-bold text-sm ${getStatusBadge(app.status)}`}
//                   >
