...
const page = () => {
  return (
    <>
      ...
      >
        <Image
          src="/images/brushes/whoweare.png"
          width={200}
          height={200}
          alt="brush stroke"
          className="w-[350px]"
      ...
      <div className="flex justify-between flex-wrap mb-[70px] w-[90%] mx-auto gap-y-[30px]">
        <Image
          src="/images/ahfnig8.jpg"
          width={200}
          height={200}
          alt="Our vision"
          className="w-[47%] h-[300px] object-cover max-[700px]:w-[100%] rounded-[40px]"
          unoptimized
        />
      ...
      <div className="my-[70px] w-[90%] mx-auto">
        ...
        <div className="mb-[30px]">
          ...
          <p className="text-[1.8rem] max-[700px]:text-[1.5rem]">
            ...
            <br />
            <span className="text-[30px] mr-[10px]">&bull;</span> Children
            suffer from eye defects and also provide education for Orphans at
            all levels.
        ...
        <div className="mb-[30px]">
          ...
          <p className="text-[1.8rem] max-[700px]:text-[1.5rem]">
            ...
            <br />
            <span className="text-[30px] mr-[10px]">&bull;</span> Prison Reform
            Scheme (PRS), to provide skill acquisition, education and counseling
