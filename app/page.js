...
import { Heart, Globe, Utensils, Activity } from "lucide-react";
  ...
  return (
    <div className="bg-white text-gray-900 overflow-x-hidden">
      ...
      <section className="w-[90%] my-[100px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-y-[70px]">
        ...
        {/* Right Image Side */}
        <div className="w-full lg:w-[45%] relative flex justify-center items-center rounded-[40px]">
          <Image
            ...
            {[
              {
                ...
                color: "#4169e1",
                text: "Providing high-quality care and resources for the vulnerable.",
              },
              {
                icon: <Heart size={32} />,
                title: "Pure Water",
              ...
              <div
                key={i}
                className="w-[24%] flex flex-col items-center max-[850px]:w-[48%] max-[450px]:w-[100%]"
              >
                <div
                ...
                <p className="text-[1.5rem] text-gray-400 w-[80%] mx-auto leading-relaxed">
                  {box.text}
                </p>
              </div>
            ))}
      ...
      <div className="w-[90%] max-w-[1000px] mx-auto mb-[100px]">
        <h3 className="text-[4rem] text-center mb-8 max-[768px]:text-[2.5rem]">
          Watch The Story Within
        </h3>
        <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-[20px] shadow-xl bg-black">
          <iframe
