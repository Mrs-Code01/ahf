    ...
    <div>
      <footer className="w-[90%] mt-40 mb-20 mx-auto">
        ...
        >
          ...
          <div className="w-[100%] flex justify-between flex-wrap gap-6">
            <button
              className="bg-[#DC2626] w-[48%] block text-white px-[10px] py-5 rounded-2xl font-black uppercase tracking-widest text-[1.3rem] hover:scale-105 transition-all shadow-xl cursor-pointer max-[545px]:w-[100%]"
            ...
            <Link
              ...
              className="bg-white  w-[48%] block  text-[#1E40AF] px-[10px] py-5 rounded-2xl font-black uppercase tracking-widest text-[1.3rem] hover:bg-slate-100 transition-all cursor-pointer max-[545px]:w-[100%]"
            >
              Volunteer Today
            </Link>
          </div>
