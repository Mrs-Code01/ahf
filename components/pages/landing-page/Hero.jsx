      ...
      <div className="relative z-20 h-full w-[90%] mx-auto flex flex-col justify-center">
        <div className="w-[50%] space-y-6">
          ...
          <p className="text-xl md:text-2xl text-zinc-300 max-w-2xl font-light leading-relaxed">
            ApiriHallowed Foundation (AHF) exists to reach the unreached,
            provide comfort to the sick, and restore dignity to the
            brokenhearted.
          </p>

          <div className="flex flex-wrap gap-5 pt-10">
            <button className="bg-red-600 hover:bg-red-700 text-white px-12 py-5 rounded-full font-black text-lg transition-all transform hover:scale-105 shadow-[0_20px_50px_rgba(220,38,38,0.3)] flex items-center gap-3">
