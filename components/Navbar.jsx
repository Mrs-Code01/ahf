...
import DonateModal from "./ModalPopUp/Donate";
...
const navItems = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      {
        label: "Love Corp Club (LCC)",
        href: "/programs/love-corp-club",
      },
      {
        label: "PACT Club",
        href: "/programs/pact",
...
export default function CharityLandingPage() {
  ...
  const isParentActive = (item) => {
    ...
    if (item.dropdown && item.dropdown.some((d) => isActive(d.href)))
      return true;
  ...
  return (
    <div className="bg-white text-gray-900 overflow-x-hidden mt-[64px] min-[1100px]:pt-20">
      {/* --- NAVBAR SECTION --- */}
      <header className="fixed top-0 left-0 right-0 z-[200] border-b border-gray-100 bg-white/95 backdrop-blur-md py-[30px]">
